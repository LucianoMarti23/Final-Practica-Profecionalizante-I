...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-11-2023 a las 16:40:25
...
--
-- Estructura de tabla para la tabla `cargoss`
--
...
--
-- Estructura de tabla para la tabla `obras_social`
--

CREATE TABLE `obras_social` (
  `id` int(11) NOT NULL,
  `obra_social` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `obras_social`
--

INSERT INTO `obras_social` (`id`, `obra_social`) VALUES
(7, 'OSPRERA'),
(8, 'INCEP');
...
CREATE TABLE `pacientes` (
  ...
  `id_obrasocial` varchar(60) DEFAULT NULL,
...
INSERT INTO `pacientes` (`id`, `apellido`, `nombre`, `domicilio`, `dni_paciente`, `id_obrasocial`, `provincia`, `celulares`, `telefonos`, `emails`) VALUES
(2, 'ERLAN', 'MAURO', NULL, '41500523', '8', NULL, NULL, '(0000)-0-0000000', ''),
(3, 'LAUTARO', 'RODRIGUEZ', NULL, '42800234', '7', NULL, NULL, '(0000)-0-0000000', '');
...
--
-- Indices de la tabla `obras_social`
--
ALTER TABLE `obras_social`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `cargoss`
--
ALTER TABLE `cargoss`
...
--
-- AUTO_INCREMENT de la tabla `obras_social`
--
ALTER TABLE `obras_social`

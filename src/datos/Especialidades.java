...
public class Especialidades {
    ...
    static final String DB = "clinica_2023"; // Nombre de la base de datos donde se va a conectar
    static final String puerto = "3306"; // Puerto de escucha en el servidor de base de datos
    static final String usuario = "luciano"; // Usuario que tiene acceso a la base de datos
    static final String pws = "123456luciano"; // Contraseña de usuario
